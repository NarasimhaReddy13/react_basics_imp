...
export const PaginationTable = () => {
    ...
    const { getTableProps, getTableBodyProps, headerGroups, page, nextPage, previousPage, canNextPage, canPreviousPage, 
        pageOptions, state, gotoPage, pageCount, setPageSize, prepareRow } = tableInstance
    ...
    return (
        <div>
            ...
            <div>
                ...
                {/* Above line is for only to display number of pages */}
                ...
                {/* When we want directly jump to some page only use below 1 line code  */}
